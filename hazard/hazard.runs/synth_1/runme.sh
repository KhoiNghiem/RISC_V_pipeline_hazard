...
HD_PWD='D:/Learning/DSR_Lab/RISC_V/code/hazard/hazard/hazard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISC_V_pp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISC_V_pp.tcl
